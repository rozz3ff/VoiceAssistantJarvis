...
volume_control = None # <--- ДОБАВЬ ЭТУ СТРОКУ (для хранения объекта управления громкостью)
...
HUGGINGFACE_HEADERS = {"Authorization": "YOUR_ACCESS_TOKEN"}
...
def main():
    ...
    if not initialize_volume_control():
         ...
         # Можно решить, продолжать ли работу или выйти
         exit() # Раскомментируй, если без громкости работа не нужна
